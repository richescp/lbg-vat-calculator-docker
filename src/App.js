...
function App() {
  ...
  return (
    <div className='header field'>
      VAT CALCULATOR built by Christian Riches
      <div className='colour-border'>
        ...
        <PriceEntryField customstyle="field" label="Price excluding VAT: " priceChanged={handleNetPriceChange} price={netPrice === 0.0 ? "" : netPrice} />
        <DisplayBlock customstyle="field" label="Exhorbitant VAT to pay: " value={vatToPay} />
        <PriceEntryField customstyle="field" label="Price including VAT: " priceChanged={handleGrossPriceChange} price={grossPrice === 0.0 ? "" : grossPrice} />
      </div>
    </div>
  );
}
